...
public class JavaInterfaceGenerator extends AbstractJavaGenerator {
     ...
     */
    @Parameter(property = "netlib.defaultImpl", defaultValue = "org.netlib.blas.JBLAS", required = true)
    protected String netlib_defaultImpl;
    ...
    protected String generate(List<Method> methods) throws Exception {
        ...
        t.add("defaultImpl", netlib_defaultImpl);
